...
mesh tree_structure::create_cylinder_mesh(float radius, float height) const
{
    mesh m;
...
mesh tree_structure::create_cone_mesh(float radius, float height, float z_offset) const
{
    mesh m;
    // To do: fill this mesh ...
    // ...
